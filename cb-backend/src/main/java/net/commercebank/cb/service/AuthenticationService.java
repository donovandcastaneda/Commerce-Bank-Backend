...
import net.commercebank.cb.entity.AuthenticationResponse;
import net.commercebank.cb.entity.Token;
import net.commercebank.cb.entity.User;
import net.commercebank.cb.repository.TokenRepository;
import net.commercebank.cb.repository.UserRepository;
